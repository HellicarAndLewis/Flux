...
void RenderRadar::selfDraw(){
    ...
    terrainShader.getShader().setUniformTexture("terrainMask", terrainMask[view].getTextureReference(), 5);
    ...
    terrainMeshShader.getShader().setUniformTexture("terrainMask", terrainMask[view].getTextureReference(), 5);
